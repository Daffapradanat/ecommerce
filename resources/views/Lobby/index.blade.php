                ...
                <div class="card shadow h-100">
                    ...
                    <div class="card-body">
                        @php
                            ...
                            $recentBuyers = \App\Models\Buyer::latest()
                                ->take(5)
                                ->get()
                                ->map(function ($buyer) {
                                    return [
                            ...
                            $recentProducts = \App\Models\Product::latest('updated_at')
                                ->take(5)
                                ->get()
                                ->map(function ($product) {
                                    return [
                                        'type' => 'product',
                                        'message' => $product->created_at->isToday()
                                            ? 'New product added'
                                            : 'Product updated',
                                        'name' => $product->name,
                                        'price' => $product->price,
                                        ...
                                        'icon' => $product->created_at->isToday()
                                            ? 'fas fa-box text-info'
                                ...
                                @foreach ($recentActivities as $activity)
                                    <li class="list-group-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <span
                                                class="badge bg-secondary rounded-pill">{{ $activity['time']->diffForHumans() }}</span>
                                        </div>
                                        <div class="mt-2">
                ...
                <div class="card shadow h-100">
                    ...
                    <div class="card-body">
                        @php
                            ...
                            $allSoldQuantity = \App\Models\OrderItem::join(
                                'orders',
